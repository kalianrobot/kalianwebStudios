...
- El validator de `finanzas` DEBE aceptar los cuatro campos como
  opcionales (compatibilidad con docs históricos) y, cuando estén
  presentes, verificar la coherencia `monto == monto_bruto -
  monto_artista` y el enum de `variante_precio`.
