                          ...
                          <div className="px-10 pb-10 pt-6 border-t border-kalian-gold/5 animate-in slide-in-from-top-4 duration-500">
                              ...
                              <div className="grid md:grid-cols-2 gap-12">
                                <div className="space-y-6">
                                  ...
                                  <div className="space-y-1">
                                    ...
                                    <p className="text-kalian-cream/90 font-bold uppercase text-sm">{formatMeses(c.fechaInicio, c.fechaFin)}</p>
                                  </div>
                                </div>
                            ...
                            <div className="flex flex-col sm:flex-row gap-4">
                              ...
                              <button 
                                ...
                                disabled={c.aforo_disponible === false || !modalidadSeleccionada[c.id]}
                                className={`flex-1 p-5 rounded-2xl kalian-poster-text text-lg tracking-widest transition-all shadow-xl ${c.aforo_disponible === false || !modalidadSeleccionada[c.id] ? 'bg-slate-800 text-slate-500 cursor-not-allowed' : 'bg-kalian-gold text-black hover:bg-white shadow-kalian-gold/20'}`}
                              >
                                {c.aforo_disponible === false ? 'CURSO CERRADO' : 'Inscribirse'}
                              </button>
                            </div>
                          </div>
                        )}
