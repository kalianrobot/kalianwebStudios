  ...
  if (error || !event) {
    return (
      <div className="min-h-screen bg-kalian-dark text-kalian-cream flex flex-col items-center justify-center p-10 text-center">
        <h1 className="text-4xl kalian-poster-text text-kalian-gold mb-4 uppercase italic">{error || 'Evento no encontrado'}</h1>
        <Link to="/programacion" className="bg-kalian-gold text-black px-8 py-3 rounded-xl font-black uppercase text-[10px] tracking-widest mt-8">VOLVER A PROGRAMACIÓN</Link>
      </div>
    );
  }
